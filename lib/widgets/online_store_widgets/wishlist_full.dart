...
import 'package:madproject/models/fav_attr.dart';
...
class _WishlistFullState extends State<WishlistFull> {
  Future<void> _confirmDeleteFromWishList(BuildContext context,
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      height: 80,
                      child: Image.network(favsAttributes.imageUrl
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: MaterialButton(
          ...
          onPressed: () {
            _confirmDeleteFromWishList(
                context,
                "Remove From Wish List!",
                "Product will me removed from you wish list, this action can't be undone are you sure you want to continue ",
