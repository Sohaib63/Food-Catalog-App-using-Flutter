...
import 'package:madproject/constants.dart';
import 'package:madproject/pages/online_store/cart.dart';
...
import 'package:madproject/widgets/online_store_widgets/empty_brand_card.dart';
import 'package:madproject/widgets/online_store_widgets/feeds_products.dart';

import '../wishlist.dart';

class CategoriesFieldsScreens extends StatefulWidget {
  final String categoryName;
  const CategoriesFieldsScreens({Key key, @required this.categoryName})
      : super(key: key);

  @override
  _CategoriesFieldsScreensState createState() =>
      _CategoriesFieldsScreensState();
}

class _CategoriesFieldsScreensState extends State<CategoriesFieldsScreens>
