...
import 'package:madproject/pages/online_store/consts/my_icons.dart';
import 'package:madproject/providers/cart_provider.dart';
import 'package:madproject/services/global_method.dart';
import 'package:madproject/widgets/online_store_widgets/cart_empty.dart';
import 'package:madproject/widgets/online_store_widgets/cart_full.dart';
...
class _CartScreenState extends State<CartScreen> {
  Future<void> _confirmDeleteCart(BuildContext context, String deleteTitle,
      String deleteSubtitle, Function fct) async {
  ...
  Widget build(BuildContext context) {
    ...
    return cartProvider.getCartItems.isEmpty
        ...
        : Scaffold(
            bottomNavigationBar:
                checkoutSection(context, cartProvider.totalAmount),
            appBar: AppBar(
                ...
                IconButton(
                  onPressed: () {
                    _confirmDeleteCart(
                        context,
                        "Remove All Items!",
                        "All the Products will me removed from you cart, this action can't be undone are you sure you want to continue ",
