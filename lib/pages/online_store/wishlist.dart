...
import 'package:madproject/widgets/online_store_widgets/wishlist_empty.dart';
import 'package:madproject/widgets/online_store_widgets/wishlist_full.dart';
import 'package:madproject/widgets/show_alert_dialog.dart';

class WishlistScreen extends StatelessWidget {
//  static const routeName = '/routeNameWishlistScreen';
  Future<void> _confirmDeleteWishList(BuildContext context, String deleteTitle,
                ...
                IconButton(
                  onPressed: () {
                    _confirmDeleteWishList(
                        context,
                        "Remove All Items!",
                        "All the Products will me removed from you wish list, this action can't be undone are you sure you want to continue ",
