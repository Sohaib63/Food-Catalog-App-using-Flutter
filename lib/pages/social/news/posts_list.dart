...
import 'package:madproject/models/facebook_posts.dart';
import 'package:madproject/pages/social/news/post_btn.dart';
    ...
    return VsScrollbar(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          var postUrl;
          if (postUrl == null)
            postUrl = Constants.facebookLink;
          else
            postUrl = data[index].attachments.data[0].url;
          return Column(
