...
class _MailFormStepperState extends State<MailFormStepper>
  ...
  bool isHTML = false;
  final String _recipientController = "habib.gcu10@gmail.com";
            ...
            children: [
              ...
              Expanded(
                child: Stepper(
                  ...
                  onStepCancel: cancel,
                  controlsBuilder: (context, ControlsDetails controls) => Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      iconBtn(
                          icon: Icons.arrow_upward_rounded,
                          onClick: controls.onStepCancel),
                      iconBtn(
                          icon: _currentStep > 1
                              ? Icons.send
                              : Icons.arrow_downward_rounded,
                          onClick: controls.onStepContinue),
                    ],
                  ),
                  steps: <Step>[
                    Step(
